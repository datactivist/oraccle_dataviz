...
La visualisation ci-dessous montre les 10 parcours étudiants les plus suivis par les élèves ayant choisi les spécialités Mathématiques et SVT au baccalauréat. Les flèches montrent les formations vers lesquelles ils se sont dirigés, avec une épaisseur qui dépend du nombre d'étudiants ayant suivi ce parcours. Lorsqu'un étudiant reste dans la même formation d'une année à une autre, une flèche sous forme de boucle est affichée pour signifier ce maintien.
